        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-dark-400 dark:text-gray-300 transition-colors duration-300">
              We create intuitive, user-centric interfaces that not only look beautiful but also drive engagement and conversion. By combining deep user research with cutting-edge design principles, we craft digital experiences that your users will love.
            </p>
          </motion.div>
        </div>
      </section>
