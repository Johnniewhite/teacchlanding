        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-dark-400 dark:text-gray-300 transition-colors duration-300">
              Transform your digital presence with our bespoke web development services. From beautiful landing pages to complex, scalable web applications, our team builds high-performance solutions tailored to your specific business needs. We focus on cutting-edge design, speed, and seamless user experiences.
            </p>
          </motion.div>
        </div>
      </section>
