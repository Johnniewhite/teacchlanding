        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-dark-400 dark:text-gray-300 transition-colors duration-300">
              We engineer robust, scalable, and highly interactive web applications designed to solve complex business challenges. Utilizing modern tech stacks and cloud architectures, our web apps deliver seamless experiences, high performance, and security from MVP to Enterprise scale.
            </p>
          </motion.div>
        </div>
      </section>
