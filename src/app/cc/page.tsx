        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-dark-400 dark:text-gray-300 transition-colors duration-300">
              Captivate your audience with high-quality content. From compelling copywriting and blog articles to premium video production and photography, we craft stories that resonate with your target market and elevate your brand&apos;s digital presence.
            </p>
          </motion.div>
        </div>
      </section>
