    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 bg-linear-to-br from-dark-500/95 via-dark-500/85 to-dark-500/75"></div>
          <div className="absolute inset-0 bg-linear-to-t from-dark-500/50 via-transparent to-transparent"></div>
          <div className="absolute inset-0 bg-linear-to-l from-teacch-green/10 via-transparent to-teacch-orange/10"></div>
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-0 mask-[radial-gradient(ellipse_80%_50%_at_50%_-20%,black,transparent)]"></div>
          </div>
        </div>
      </div>

      {/* Main Content Container */}
      <div className="relative container mx-auto flex flex-col min-h-dvh px-4 sm:px-6 lg:px-8">
        {/* Content Wrapper */}
        <div className="flex-1 flex flex-col justify-center items-center pt-20 pb-24">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center px-3 py-1.5 sm:px-6 sm:py-2 rounded-full bg-linear-to-r from-white/10 via-white/20 to-white/10 backdrop-blur-md mb-4 sm:mb-8 border border-white/20 shadow-2xl shadow-dark-500/20"
            >
              <span className="relative text-xs sm:text-sm md:text-base font-medium text-white uppercase tracking-wider whitespace-normal wrap-break-word max-w-full">
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-5xl md:text-6xl lg:text-5xl xl:text-8xl font-bold font-display mb-4 sm:mb-8 text-white leading-[1.1] tracking-tight wrap-break-word"
            >
              <span className="inline">Empowering{' '}</span>
              <span className="relative inline-block">
                <span className="relative z-10 text-gradient bg-linear-to-r from-teacch-green via-teacch-orange to-teacch-green bg-clip-text text-transparent wrap-break-word">
                  Social Innovation
                </span>
                <motion.span
                  className="absolute inset-0 bg-linear-to-r from-teacch-green/20 via-teacch-orange/20 to-teacch-green/20 blur-2xl -z-10"
                  animate={{ 
                    opacity: [0.5, 0.8, 0.5],
                    scale: [1, 1.1, 1]
                  }}
            ...
            <motion.p
              ...
              className="text-base sm:text-xl md:text-2xl text-gray-300 mb-6 sm:mb-12 mx-auto leading-relaxed font-light max-w-[min(95%,48rem)] wrap-break-word"
            >
